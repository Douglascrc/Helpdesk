package br.com.codigodebase.helpdesk.infrastructure.security;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    private UserDetails getUserDetails(String token) {
        ...
        if (jwtSubject != null) {
            CustomUserDetails userDetails = new CustomUserDetails(userInputPort.findByUsername(jwtSubject));
            if (userDetails != null) {
                return userDetails;
            }
        }
